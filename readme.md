...
* 소프트맥스 함수 : 분류(classification)에 쓰인다. 사진 속 인물의 성별 분류와 같은 것에 쓰인다. <br/> 자연상수 e = 2.7182... <br/>
소프트맥스 함수는 총 합은 항상 1이며, 단조증가함수(a >= b일 때, f(a) >= f(b)가 성립하는 함수)이기 때문에 현업에서는 생략한다고 한다. <br/> 
